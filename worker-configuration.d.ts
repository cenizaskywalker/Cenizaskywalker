/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b5e3837211a35e3ee496009f12fdb58f)
...
interface __BaseEnv_Env {
	...
	PUBLICATIONS: DurableObjectNamespace<import("./worker/index").PublicationHub>;
	PASSWORD_HASHER: DurableObjectNamespace<import("./worker/index").PasswordHasher>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "PublicationHub" | "PasswordHasher";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_SECONDS" | "MAX_UPLOAD_BYTES">> {}
}
